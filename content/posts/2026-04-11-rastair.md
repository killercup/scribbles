...
[paper]: https://www.biorxiv.org/content/10.64898/2026.03.19.712983v1 "Rastair: an integrated variant and methylation caller | bioRxiv"
...
At the end,
we remove all reads with [`swap_remove`][struct-vec]
by going over the skip list in reverse.
The suffix lists are cleared and reused between positions.

[struct-vec]: https://doc.rust-lang.org/1.94.1/std/vec/struct.Vec.html#method.swap_remove "Vec::swap_remove docs"
...
You can see the result on [rastair.com][rastair-2].
...
[rastair-2]: https://www.rastair.com/ "Introduction - Rastair"

Rastair is a CLI tool written in Rust,
so to nobody's surprise it uses [`clap`][clap]
for defining its command-line arguments and subcommands.
Using [clap-markdown][clap-markdown],
we also show the CLI help on the website.

[clap]: https://docs.rs/clap/4.6.0/clap/ "clap docs"
[clap-markdown]: https://docs.rs/clap-markdown/0.1.5/clap_markdown/ "clap_markdown docs"
