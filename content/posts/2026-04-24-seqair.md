...
but I guess also since its strictness is good immeditate feedback for LLMs
...
If you see its useful to you and your company benefits from this,
reach out[^business].
...
Especially in research, this is the only viable way to solve hard problem.
...
one each for names, bases, CIGAR bytes, quality, and auxilary tags.

[record-store]: https://github.com/Softleif/seqair/blob/aff5332bde2580fed615daedfa105ddba51f8f09/crates/seqair/src/bam/record_store.rs
...
For this, I wrote some benchmarks using [`criterion`]
and they all pretty much confirm one thing:
**We're all in the same ballpark.**
Not 2x faster, not 2x slower.

That's as much as I can take away from these benchmarks.
The real test is putting this into Rastair,
profiling representative runs, and optimizing.
That's what I did for the *htstlib*
and it would surprise me if I would get away with not doing it again.
