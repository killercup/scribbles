...
We'll go into details of one of my main design choice here,
...
[^llm]: I'll probably write about the LLM aspect of this separately,
...
[^seq-simd]: _Bonus:_ Seqair decodes the 4-bit packed sequence
...
5. Push-time filtering and per-record extras as opt-in extensions of the same slab design.
   Both cost nothing when unused, and they lean on the existing offsets
   rather than adding some parallel system.
