...
We'll go into details of my Rust design choices
alongside some explanations on bioinformaticsd] details.
...
and _htslib_ and [noodles] are each presenting only one of them.
...
(I'll probably write about the LLM side of this separately.)
