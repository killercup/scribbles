...
a new Rust library I've been working on.
It's a bit heavy on bioinformatics specifics
but also goes into details of my Rust design choices.
...
Either fiddle with the raw pointers to _htslib_ structs,
...
and _htslib_ and _noodles_ are each presenting only one of them.
...
On logging:
some _htslib_ logs always show up
...
[rastair-post]: https://deterministic.space/rastair.html "My post introducint Rastair"

I think I went further with this than both _noodles_ and `rust-htslib`
...
_Bonus:_ For the 4-bit packed sequence in BAM,
...
The microbenchmarks sit in the same ballpark as _htslib_.
...
Some preliminary tests make me quite happy,
but I'll get back to this topic after some more work has been done.
