...
We'll look in details at of one of my main design choices here,
...
and _htslib_ and _[noodles]_ each present only one of them.
...
There are many aspecs to this and I want to name only a few of them here.
...
| Benchmark           | htslib | seqair | noodles | Comment                     |
| ------------------- | -----: | -----: | ------: | --------------------------- |
...
I could get the initital integration to
zero diff lines against existing Rastair output,
even on quite big files.

I could proof that my columnar storage design makes sense.
...
I could get some some "bonus features" in
