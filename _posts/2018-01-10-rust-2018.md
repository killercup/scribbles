...
[^intermediate]: This has also been called "intermediate level documentation". If this seems fuzzy to you, and my above list doesn't look as metaphorically exciting as it could be, have a look at [one](https://twitter.com/) [of](https://twitter.com/) [these](https://twitter.com/) tweets.
...
At the end of 2018 this implicitly happened a bit
